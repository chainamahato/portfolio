...
var DateAdapter = class {
  ...
  locale;
  _localeChanges = new import_rxjs9.Subject();
...
var MatOption = class _MatOption {
  ...
  _stateChanges = new import_rxjs9.Subject();
  constructor() {
...
var MatDialogRef = class {
  ...
  _afterOpened = new import_rxjs10.Subject();
  /** Subject for notifying the user that the dialog has started closing. */
  _beforeClosed = new import_rxjs10.Subject();
  ...
  constructor(_ref, config, _containerInstance) {
    ...
    _containerInstance._animationStateChanged.pipe((0, import_operators8.filter)((event) => event.state === "opened"), (0, import_operators8.take)(1)).subscribe(() => {
      this._afterOpened.next();
      this._afterOpened.complete();
    });
    _containerInstance._animationStateChanged.pipe((0, import_operators8.filter)((event) => event.state === "closed"), (0, import_operators8.take)(1)).subscribe(() => {
    ...
    (0, import_rxjs10.merge)(this.backdropClick(), this.keydownEvents().pipe((0, import_operators8.filter)((event) => event.keyCode === ESCAPE && !this.disableClose && !hasModifierKey(event)))).subscribe((event) => {
      if (!this.disableClose) {
        event.preventDefault();
  ...
  close(dialogResult) {
    ...
    this._containerInstance._animationStateChanged.pipe((0, import_operators8.filter)((event) => event.state === "closing"), (0, import_operators8.take)(1)).subscribe((event) => {
...
var MatDialog = class _MatDialog {
  ...
  _openDialogsAtThisLevel = [];
  _afterAllClosedAtThisLevel = new import_rxjs10.Subject();
  _afterOpenedAtThisLevel = new import_rxjs10.Subject();
   ...
   * Will emit on subscribe if there are no open dialogs to begin with.
   */
  afterAllClosed = (0, import_rxjs10.defer)(() => this.openDialogs.length ? this._getAfterAllClosed() : this._getAfterAllClosed().pipe((0, import_operators8.startWith)(void 0)));
  constructor() {
